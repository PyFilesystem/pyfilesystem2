...
def write_zip(src_fs,
        ...
        :param encoding: The encoding to use for filenames. The default
            is ``"utf-8"``, use ``"CP437"`` if compatibility with
            WinZip is desired.
        :type encoding: str
        ...
        with _zip:
            gen_walk = walk_info(src_fs, namespaces=["details", "stat"])
