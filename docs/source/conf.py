...
latex_documents = [
    (master_doc, 'PyFilesystem2.tex', u'PyFilesystem2 Documentation',
...
man_pages = [
    (master_doc, 'pyfilesystem2', u'PyFilesystem2 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyFilesystem2', u'PyFilesystem2 Documentation',
     author, 'PyFilesystem2', 'One line description of project.',
     'Miscellaneous'),
]
